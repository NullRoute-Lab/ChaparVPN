package com.chapar.vpn.service
...
import com.chapar.vpn.App
import com.chapar.vpn.MainActivity
import com.chapar.vpn.R
import com.chapar.vpn.data.local.AppDatabase
import com.chapar.vpn.util.ConfigGenerator
import com.chapar.vpn.util.GlobalSettingsStore
import com.chapar.vpn.util.VpnManager
...
class ChaparVpnService : VpnService() {

    companion object {
        const val ACTION_CONNECT = "com.chapar.vpn.CONNECT"
        const val ACTION_DISCONNECT = "com.chapar.vpn.DISCONNECT"
        const val EXTRA_PROFILE_ID = "profile_id"
        private const val TAG = "ChaparRelayVPN"
    ...
    private fun startVpn(profileId: Long) {
        ...
        connectJob = serviceScope.launch {
            try {
                ...
                val db = AppDatabase.getInstance(this@ChaparVpnService)
                ...
                val globalSettings = GlobalSettingsStore.load(this@ChaparVpnService)
                ...
                if (proxyMode) {
                    ...
                    VpnManager.startTrafficMonitor(this@ChaparVpnService)
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                    ...
                    if (splitEnabled) {
                        ...
                        if (globalSettings.splitTunnelMode == com.chapar.vpn.util.SplitTunnelMode.INCLUDE) {
            ...
            if (requiresAuth && !isValidBasicProxyAuth(authHeader, username, password)) {
                output.write(
                    "HTTP/1.1 407 Proxy Authentication Required\r\n" +
                        "Proxy-Authenticate: Basic realm=\"ChaparRelayVPN\"\r\n" +
                        "Connection: close\r\n\r\n"
                )
                output.flush()
                return
